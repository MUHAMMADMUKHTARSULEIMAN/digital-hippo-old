...
export const PrimaryActionEmail = ({actionLabel, buttonText, href}: PrimaryActionEmailProps) => {
  return (
    <Html>
      <Head />
...
export const PrimaryActionEmailHtml = (props: PrimaryActionEmailProps) => render(<PrimaryActionEmail {...props} />, {pretty: true})
