  ...
  return (
    <div className="bg-background">
      <div className="mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
        <h1 className="text-3xl font-bold tracking-tight text-accent-foreground sm:text-4xl">Shopping Cart</h1>
        <div className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
          <div className={
            cn("lg:col-span-7", {"rounded-lg border-2 border-dashed p-12": isMounted && items.length === 0})
          }>
                      ...
                      <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                        <div>
                          <div className="flex justify-between">
                            <h3 className="text-sm">
                              <Link href={`/product/${product.id}`} className="font-semibold text-gray-700 hover:text-accent-foreground">{product.name}</Link>
                            </h3>
                          </div>
                        ...
                        <div className="mt-4 sm:mt-0 sm:pr-9 w-20">
                          <div className="absolute right-0 top-0">
                            <Button aria-label="Remove Product" variant="ghost"><X onClick={() => removeItem(product.id)} className="h-5 w-5" aria-hidden="true"/></Button>
                          </div>
                        </div>
                      </div>
                      <p className="mt-4 flex space-x-2 text-sm text-accent-foreground">
          ...
          <section className="mt-16 rounded-lg bg-muted px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8">
            <h2 className="text-lg font-medium text-accent-foreground">Order Summary</h2>
            <div className="mt-6 space-y-4">
              ...
              <div className="flex items-center justify-between border-t pt-4">
                <div className="text-base font-medium text-accent-foreground">Order Total</div>
